            ...
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 bg-white/50 dark:bg-zinc-900/50 border-zinc-100 dark:border-zinc-800 backdrop-blur-sm">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center">
                                    <svg className="text-zinc-200 dark:text-zinc-800 absolute inset-0 size-full" viewBox="0 0 254 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <span className="mx-auto block w-fit text-5xl font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">100%</span>
                                </div>
                                <h2 className="mt-6 text-center text-3xl font-semibold text-zinc-900 dark:text-zinc-50">Project Analytics</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-white/50 dark:bg-zinc-900/50 border-zinc-100 dark:border-zinc-800 backdrop-blur-sm">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5 bg-zinc-50 dark:bg-zinc-900/50">
                                    <svg className="m-auto h-fit w-24 text-blue-500" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <div className="absolute inset-x-0 bottom-0 top-1/2 flex items-center justify-center">
                                    <div className="relative text-center">
                                        <h3 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">Instant Sync</h3>
                                        <p className="text-zinc-500 dark:text-zinc-400 text-sm mt-1">Updates across the globe in milliseconds.</p>
                                    </div>
                                </div>
                            </div>
                        </CardContent>
                        ...
                        <CardContent className="pt-6">
                            <div className="pt-6 lg:px-6">
                                <svg className="dark:text-zinc-500 w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="386" height="123" rx="10" fill="currentColor" className="text-zinc-50 dark:text-zinc-800/50" />
                                    <g clipPath="url(#clip0_0_106)">
                                        {/* Simplified version of the complex paths to save tokens but keep the visual weight */}
                                        <path d="M29 29m-15 0a15 15 0 1 0 30 0a15 15 0 1 0 -30 0" stroke="currentColor" className="text-zinc-300 dark:text-zinc-600" />
                                        <path d="M50 20h200v20h-200z" fill="currentColor" className="text-zinc-200 dark:text-zinc-700" />
                                        {/* Keeping the graph line */}
                                        <path
                            ...
                            <div className="relative z-10 mt-6 space-y-2 text-center pb-6">
                                <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-50 transition">Real-time Sync</h2>
                                <p className="text-zinc-500 text-sm">Consistent data state across all client devices.</p>
                            </div>
                        </CardContent>
                    </Card>
                    <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-white/50 dark:bg-zinc-900/50 border-zinc-100 dark:border-zinc-800 backdrop-blur-sm">
                        <CardContent className="grid pt-6 sm:grid-cols-2">
                            <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                <div className="relative flex aspect-square size-12 rounded-full border border-zinc-200 dark:border-white/10 dark:before:border-white/5 bg-zinc-50 dark:bg-zinc-800/50">
                                    <Shield className="m-auto size-5 text-blue-600" strokeWidth={2} />
                                </div>
                                <div className="space-y-2">
                                    <h2 className="group-hover:text-blue-600 text-lg font-bold text-zinc-900 transition dark:text-white">Enterprise Grade</h2>
                                    <p className="text-zinc-500 dark:text-zinc-400 text-sm">Bank-level security and compliance baked into the core platform.</p>
                                </div>
                            </div>
                            <div className="rounded-tl-2xl relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6 bg-zinc-50/50 dark:bg-zinc-900/50">
                                <div className="absolute left-3 top-2 flex gap-1">
                                    <span className="block size-2 rounded-full border bg-zinc-200/50"></span>
                                    <span className="block size-2 rounded-full border bg-zinc-200/50"></span>
                                    <span className="block size-2 rounded-full border bg-zinc-200/50"></span>
                                </div>
                                {/* Abstract code/shield representation */}
                                <div className="space-y-2 pt-2">
                                    <div className="h-2 w-3/4 bg-blue-100 dark:bg-blue-900/30 rounded"></div>
                                    <div className="h-2 w-1/2 bg-blue-100 dark:bg-blue-900/30 rounded"></div>
                                    <div className="h-2 w-5/6 bg-blue-100 dark:bg-blue-900/30 rounded"></div>
                                    <div className="h-2 w-2/3 bg-blue-100 dark:bg-blue-900/30 rounded"></div>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-white/50 dark:bg-zinc-900/50 border-zinc-100 dark:border-zinc-800 backdrop-blur-sm">
                        <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                            <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                <div className="relative flex aspect-square size-12 rounded-full border border-zinc-200 dark:border-white/10 dark:before:border-white/5 bg-zinc-50 dark:bg-zinc-800/50">
                                    <Users className="m-auto size-6 text-indigo-600" strokeWidth={2} />
                                </div>
                                <div className="space-y-2">
                                    <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-50 transition">Team Collaboration</h2>
                                    <p className="text-zinc-500 dark:text-zinc-400 text-sm">Keep your team aligned, engaged, and productive.</p>
                                </div>
                            </div>
                            <div className="relative mt-6 sm:-my-6 sm:-mr-6 h-full flex flex-col justify-center">
                                <div className="relative flex h-full flex-col justify-center space-y-4 py-6 px-6 bg-zinc-50/30 dark:bg-zinc-900/30">
                                    ...
                                    <div className="text-sm font-medium text-zinc-900 dark:text-zinc-200 pl-2">
